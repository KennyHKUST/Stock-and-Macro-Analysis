...
rootdir="/Users/lixinran/Documents/LiXi/earning_season/Update_file/Update_quarter/1010"
                        ...
                        for i in range(3,32):
                            ...
                            if sqlColData[sqlcolDict[i-2]]!=csvColData[sqlcolDict[i-2]]: #by item, if the data in csv is different from the one in mysql
                                ...
                                try: 
                                    ...
                                    conn.commit()
                                    if sqlcolDict[i-2]=='tot_rev' or sqlcolDict[i-2]=='netinc_inextra_bedist':                                       
                                        foupdate.write(ric+'t'+sqlcolDict[i-2]+'\n')
