...
rootdir="/Users/lixinran/Documents/LiXi/earning_season/Update_file/Update_quarter/1024"
                ...
                try:
                    ...
                    for row in results:
                        for i in range(3,32):
                            ...
                            if sqlColData[sqlcolDict[i-2]]-csvColData[sqlcolDict[i-2]]>1: #by item, if the data in csv is different from the one in mysql
